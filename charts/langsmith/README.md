...
![Version: 0.13.38](https://img.shields.io/badge/Version-0.13.38-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.13.38](https://img.shields.io/badge/AppVersion-0.13.38-informational?style=flat-square)
...
| images.aceBackendImage.tag | string | `"0.13.38"` |  |
...
| images.agentBuilderImage.tag | string | `"0.13.38"` |  |
...
| images.agentBuilderToolServerImage.tag | string | `"0.13.38"` |  |
...
| images.agentBuilderTriggerServerImage.tag | string | `"0.13.38"` |  |
| images.backendImage.pullPolicy | string | `"IfNotPresent"` |  |
| images.backendImage.repository | string | `"docker.io/langchain/langsmith-backend"` |  |
| images.backendImage.tag | string | `"0.13.38"` |  |
| images.clickhouseImage.pullPolicy | string | `"Always"` |  |
| images.clickhouseImage.repository | string | `"docker.io/clickhouse/clickhouse-server"` |  |
| images.clickhouseImage.tag | string | `"25.12"` |  |
| images.frontendImage.pullPolicy | string | `"IfNotPresent"` |  |
| images.frontendImage.repository | string | `"docker.io/langchain/langsmith-frontend"` |  |
| images.frontendImage.tag | string | `"0.13.38"` |  |
...
| images.hostBackendImage.tag | string | `"0.13.38"` |  |
...
| images.insightsAgentImage.tag | string | `"0.13.38"` |  |
| images.operatorImage.pullPolicy | string | `"IfNotPresent"` |  |
| images.operatorImage.repository | string | `"docker.io/langchain/langgraph-operator"` |  |
| images.operatorImage.tag | string | `"0.1.47"` |  |
| images.platformBackendImage.pullPolicy | string | `"IfNotPresent"` |  |
| images.platformBackendImage.repository | string | `"docker.io/langchain/langsmith-go-backend"` |  |
| images.platformBackendImage.tag | string | `"0.13.38"` |  |
| images.playgroundImage.pullPolicy | string | `"IfNotPresent"` |  |
| images.playgroundImage.repository | string | `"docker.io/langchain/langsmith-playground"` |  |
| images.playgroundImage.tag | string | `"0.13.38"` |  |
...
| images.pollyAgentImage.tag | string | `"0.13.38"` |  |
...
| config.security | object | `{"cors":{"allowedOrigins":"*","allowedOriginsRegex":"","alwaysAllowPathsRegex":""},"ssrf":{"allowPrivateIpsMcpServers":true,"allowPrivateIpsTools":true,"allowPrivateIpsWebhooks":true}}` | Security configuration for CORS, headers, and other security-related settings. These settings control cross-origin access and help protect against common web vulnerabilities. |
...
| config.security.ssrf | object | `{"allowPrivateIpsMcpServers":true,"allowPrivateIpsTools":true,"allowPrivateIpsWebhooks":true}` | SSRF (Server-Side Request Forgery) protection configuration. Controls whether private IP ranges (RFC 1918) are allowed for specific surfaces. Defaults to true for self-hosted deployments. Set individual toggles to false if not needed to harden your security posture. Cloud metadata, localhost, and Kubernetes internal DNS protections remain enforced regardless of these settings. |
| config.security.ssrf.allowPrivateIpsMcpServers | bool | `true` | Allow MCP servers to use private IP addresses for CRUD, proxy, and agent builder MCP client operations. Set to false if your MCP servers are not hosted on internal networks. |
| config.security.ssrf.allowPrivateIpsTools | bool | `true` | Allow tools.json mcp_server_url validation to accept private IP addresses. Set to false if your MCP server URLs do not reference internal networks. |
| config.security.ssrf.allowPrivateIpsWebhooks | bool | `true` | Allow webhooks (run rules, prompt, alert, agent builder) to target private IP addresses. Set to false if your webhooks only target public endpoints. |
