...
| images.aceBackendImage.tag | string | `"0.16.47"` |  |
...
| images.agentBuilderImage.tag | string | `"0.16.47"` |  |
| images.backendImage.pullPolicy | string | `"IfNotPresent"` |  |
| images.backendImage.repository | string | `"docker.io/langchain/langsmith-backend"` |  |
| images.backendImage.tag | string | `"0.16.47"` |  |
...
| images.engineInsightsAgentImage.tag | string | `"0.16.47"` |  |
| images.frontendImage.pullPolicy | string | `"IfNotPresent"` |  |
| images.frontendImage.repository | string | `"docker.io/langchain/langsmith-frontend"` |  |
| images.frontendImage.tag | string | `"0.16.47"` |  |
...
| images.pollyAgentImage.tag | string | `"0.16.47"` |  |
...
| images.smithdbImage.tag | string | `"0.16.47"` |  |
