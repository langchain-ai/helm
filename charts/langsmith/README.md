...
| config.sandboxes.runtimeSecret.create | bool | `true` | Create the sandbox-external Secret in the LangSmith release namespace. |
| config.sandboxes.runtimeSecret.existingSecretName | string | `""` | Existing Secret in the LangSmith release namespace with x_service_auth_jwt_secret. |
