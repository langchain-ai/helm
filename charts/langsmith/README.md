...
| config.sandboxes | object | `{"callbackSigningJwk":"","clusterName":"","createNamespace":true,"defaultBlueprintImage":"","enabled":false,"firecrackerSizeClasses":[{"memoryMib":1792,"name":"small","vcpus":1},{"memoryMib":3840,"name":"medium","vcpus":1},{"memoryMib":7936,"name":"large","vcpus":2},{"memoryMib":16128,"name":"xlarge","vcpus":4}],"juicefs":{"bucket":"","csi":{"configSecretName":"juicefs-csi-config","configSecretNamespace":"","existingSecretName":"","mountPath":"/juicefs","pvName":"smithbox-juicefs-csi","pvcName":"smithbox-juicefs-csi"},"name":"sandbox-juicefs","redis":{"metaURL":""},"storage":"s3"},"limits":{"maxCpuCores":16,"maxEphemeralStorageGb":100,"maxMemoryGb":64,"maxSandboxes":1000,"minEphemeralStorageGb":1},"namespace":"langsmith-sandboxes","proxyCa":{"certManager":{"createIssuer":true,"duration":"8760h","issuerKind":"Issuer","issuerName":"smithbox-proxy-selfsigned","renewBefore":"720h"},"existingSecretName":"","mode":"generatedSecret","secretName":"smithbox-proxy-ca"},"runtimeSecret":{"callbackSigningJwkKey":"sandbox_callback_signing_jwk","create":true,"existingSecretName":"","secretName":"sandbox-external","xServiceAuthJwtSecretKey":"x_service_auth_jwt_secret","xServiceAuthJwtSecretPreviousKey":"x_service_auth_jwt_secret_previous"},"sandboxHost":{"containerPort":19190,"daemonSet":{"annotations":{},"labels":{},"nodeSelector":{},"podAnnotations":{},"resources":{"requests":{"cpu":"2","memory":"2Gi"}},"securityContext":{"privileged":true},"terminationGracePeriodSeconds":300,"tolerations":[{"effect":"NoSchedule","key":"sandbox.langsmith.com/host","operator":"Equal","value":"true"}]},"name":"sandbox-host","serviceAccount":{"annotations":{},"automountServiceAccountToken":true,"create":true,"labels":{},"name":""}},"sandboxHostInstaller":{"daemonSet":{"annotations":{},"labels":{},"maxUnavailable":1,"podAnnotations":{},"resources":{"limits":{"cpu":"200m","memory":"128Mi"},"requests":{"cpu":"10m","memory":"32Mi"}},"securityContext":{"runAsUser":0},"timeout":"120s"},"name":"sandbox-host-installer"},"smithboxControl":{"containerPort":9090,"deployment":{"annotations":{},"labels":{},"nodeSelector":{},"podAnnotations":{},"replicas":2,"resources":{"limits":{"cpu":"2","memory":"8Gi"},"requests":{"cpu":"2","memory":"8Gi"}},"securityContext":{"privileged":true},"tolerations":[]},"hostObserverEnabled":true,"name":"smithbox-control","redisDisableClientSetinfo":false,"runtimeLifecycleReconcilerEnabled":false,"service":{"annotations":{},"labels":{},"port":9090,"type":"ClusterIP"},"serviceAccount":{"annotations":{},"automountServiceAccountToken":true,"create":true,"labels":{},"name":""}},"xServiceAuthJwtSecret":"","xServiceAuthJwtSecretPrevious":""}` | LangSmith Sandboxes runtime configuration. Disabled by default. When disabled, this chart does not manage resources in the sandbox namespace. This supports the same-cluster sandbox-host architecture only. |
...
| config.sandboxes.createNamespace | bool | `true` | Create config.sandboxes.namespace. Set false when the namespace is managed outside this chart, for example to create required Secrets before Helm install. |
...
| config.sandboxes.juicefs.csi.configSecretNamespace | string | `""` | Namespace for the JuiceFS CSI config Secret. Empty uses the Helm release namespace. |
