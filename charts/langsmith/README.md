...
| smithdb.clusterManager.containerPort | int | `8090` | SmithDB cluster manager HTTP port. |
...
| smithdb.compaction.containerPort | int | `8070` | SmithDB compaction HTTP port. |
...
| smithdb.compactionWorker.containerPort | int | `9000` | SmithDB compaction worker HTTP port. |
...
| smithdb.ingestion.containerPort | int | `8050` | SmithDB ingestion HTTP port. |
...
| smithdb.query.containerPort | int | `8060` | SmithDB query HTTP port. |
