...
![Version: 0.15.0-rc.3](https://img.shields.io/badge/Version-0.15.0--rc.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.15.1rc2](https://img.shields.io/badge/AppVersion-0.15.1rc2-informational?style=flat-square)
...
| fleet.redis.deployment.affinity | object | `{}` |  |
| fleet.redis.deployment.annotations | object | `{}` |  |
| fleet.redis.deployment.command | list | `[]` |  |
| fleet.redis.deployment.extraContainerConfig | object | `{}` |  |
| fleet.redis.deployment.extraEnv | list | `[]` |  |
| fleet.redis.deployment.labels | object | `{}` |  |
| fleet.redis.deployment.lifecycle | object | `{}` |  |
| fleet.redis.deployment.livenessProbe.exec.command[0] | string | `"/bin/sh"` |  |
| fleet.redis.deployment.livenessProbe.exec.command[1] | string | `"-c"` |  |
| fleet.redis.deployment.livenessProbe.exec.command[2] | string | `"exec redis-cli ping"` |  |
| fleet.redis.deployment.livenessProbe.failureThreshold | int | `6` |  |
| fleet.redis.deployment.livenessProbe.periodSeconds | int | `10` |  |
| fleet.redis.deployment.livenessProbe.timeoutSeconds | int | `1` |  |
| fleet.redis.deployment.nodeSelector | object | `{}` |  |
| fleet.redis.deployment.podSecurityContext | object | `{}` |  |
| fleet.redis.deployment.priorityClassName | string | `""` |  |
| fleet.redis.deployment.readinessProbe.exec.command[0] | string | `"/bin/sh"` |  |
| fleet.redis.deployment.readinessProbe.exec.command[1] | string | `"-c"` |  |
| fleet.redis.deployment.readinessProbe.exec.command[2] | string | `"exec redis-cli ping"` |  |
| fleet.redis.deployment.readinessProbe.failureThreshold | int | `6` |  |
| fleet.redis.deployment.readinessProbe.periodSeconds | int | `10` |  |
| fleet.redis.deployment.readinessProbe.timeoutSeconds | int | `1` |  |
| fleet.redis.deployment.resources | object | `{}` |  |
| fleet.redis.deployment.securityContext | object | `{}` |  |
| fleet.redis.deployment.sidecars | list | `[]` |  |
| fleet.redis.deployment.startupProbe.exec.command[0] | string | `"/bin/sh"` |  |
| fleet.redis.deployment.startupProbe.exec.command[1] | string | `"-c"` |  |
| fleet.redis.deployment.startupProbe.exec.command[2] | string | `"exec redis-cli ping"` |  |
| fleet.redis.deployment.startupProbe.failureThreshold | int | `6` |  |
| fleet.redis.deployment.startupProbe.periodSeconds | int | `10` |  |
| fleet.redis.deployment.startupProbe.timeoutSeconds | int | `1` |  |
| fleet.redis.deployment.terminationGracePeriodSeconds | int | `30` |  |
| fleet.redis.deployment.tolerations | list | `[]` |  |
| fleet.redis.deployment.volumeMounts | list | `[]` |  |
| fleet.redis.deployment.volumes | list | `[]` |  |
...
| insights.redis.deployment.affinity | object | `{}` |  |
| insights.redis.deployment.annotations | object | `{}` |  |
| insights.redis.deployment.command | list | `[]` |  |
| insights.redis.deployment.extraContainerConfig | object | `{}` |  |
| insights.redis.deployment.extraEnv | list | `[]` |  |
| insights.redis.deployment.labels | object | `{}` |  |
| insights.redis.deployment.lifecycle | object | `{}` |  |
| insights.redis.deployment.livenessProbe.exec.command[0] | string | `"/bin/sh"` |  |
| insights.redis.deployment.livenessProbe.exec.command[1] | string | `"-c"` |  |
| insights.redis.deployment.livenessProbe.exec.command[2] | string | `"exec redis-cli ping"` |  |
| insights.redis.deployment.livenessProbe.failureThreshold | int | `6` |  |
| insights.redis.deployment.livenessProbe.periodSeconds | int | `10` |  |
| insights.redis.deployment.livenessProbe.timeoutSeconds | int | `1` |  |
| insights.redis.deployment.nodeSelector | object | `{}` |  |
| insights.redis.deployment.podSecurityContext | object | `{}` |  |
| insights.redis.deployment.priorityClassName | string | `""` |  |
| insights.redis.deployment.readinessProbe.exec.command[0] | string | `"/bin/sh"` |  |
| insights.redis.deployment.readinessProbe.exec.command[1] | string | `"-c"` |  |
| insights.redis.deployment.readinessProbe.exec.command[2] | string | `"exec redis-cli ping"` |  |
| insights.redis.deployment.readinessProbe.failureThreshold | int | `6` |  |
| insights.redis.deployment.readinessProbe.periodSeconds | int | `10` |  |
| insights.redis.deployment.readinessProbe.timeoutSeconds | int | `1` |  |
| insights.redis.deployment.resources | object | `{}` |  |
| insights.redis.deployment.securityContext | object | `{}` |  |
| insights.redis.deployment.sidecars | list | `[]` |  |
| insights.redis.deployment.startupProbe.exec.command[0] | string | `"/bin/sh"` |  |
| insights.redis.deployment.startupProbe.exec.command[1] | string | `"-c"` |  |
| insights.redis.deployment.startupProbe.exec.command[2] | string | `"exec redis-cli ping"` |  |
| insights.redis.deployment.startupProbe.failureThreshold | int | `6` |  |
| insights.redis.deployment.startupProbe.periodSeconds | int | `10` |  |
| insights.redis.deployment.startupProbe.timeoutSeconds | int | `1` |  |
| insights.redis.deployment.terminationGracePeriodSeconds | int | `30` |  |
| insights.redis.deployment.tolerations | list | `[]` |  |
| insights.redis.deployment.volumeMounts | list | `[]` |  |
| insights.redis.deployment.volumes | list | `[]` |  |
...
| polly.redis.deployment.affinity | object | `{}` |  |
| polly.redis.deployment.annotations | object | `{}` |  |
| polly.redis.deployment.command | list | `[]` |  |
| polly.redis.deployment.extraContainerConfig | object | `{}` |  |
| polly.redis.deployment.extraEnv | list | `[]` |  |
| polly.redis.deployment.labels | object | `{}` |  |
| polly.redis.deployment.lifecycle | object | `{}` |  |
| polly.redis.deployment.livenessProbe.exec.command[0] | string | `"/bin/sh"` |  |
| polly.redis.deployment.livenessProbe.exec.command[1] | string | `"-c"` |  |
| polly.redis.deployment.livenessProbe.exec.command[2] | string | `"exec redis-cli ping"` |  |
| polly.redis.deployment.livenessProbe.failureThreshold | int | `6` |  |
| polly.redis.deployment.livenessProbe.periodSeconds | int | `10` |  |
| polly.redis.deployment.livenessProbe.timeoutSeconds | int | `1` |  |
| polly.redis.deployment.nodeSelector | object | `{}` |  |
| polly.redis.deployment.podSecurityContext | object | `{}` |  |
| polly.redis.deployment.priorityClassName | string | `""` |  |
| polly.redis.deployment.readinessProbe.exec.command[0] | string | `"/bin/sh"` |  |
| polly.redis.deployment.readinessProbe.exec.command[1] | string | `"-c"` |  |
| polly.redis.deployment.readinessProbe.exec.command[2] | string | `"exec redis-cli ping"` |  |
| polly.redis.deployment.readinessProbe.failureThreshold | int | `6` |  |
| polly.redis.deployment.readinessProbe.periodSeconds | int | `10` |  |
| polly.redis.deployment.readinessProbe.timeoutSeconds | int | `1` |  |
| polly.redis.deployment.resources | object | `{}` |  |
| polly.redis.deployment.securityContext | object | `{}` |  |
| polly.redis.deployment.sidecars | list | `[]` |  |
| polly.redis.deployment.startupProbe.exec.command[0] | string | `"/bin/sh"` |  |
| polly.redis.deployment.startupProbe.exec.command[1] | string | `"-c"` |  |
| polly.redis.deployment.startupProbe.exec.command[2] | string | `"exec redis-cli ping"` |  |
| polly.redis.deployment.startupProbe.failureThreshold | int | `6` |  |
| polly.redis.deployment.startupProbe.periodSeconds | int | `10` |  |
| polly.redis.deployment.startupProbe.timeoutSeconds | int | `1` |  |
| polly.redis.deployment.terminationGracePeriodSeconds | int | `30` |  |
| polly.redis.deployment.tolerations | list | `[]` |  |
| polly.redis.deployment.volumeMounts | list | `[]` |  |
| polly.redis.deployment.volumes | list | `[]` |  |
