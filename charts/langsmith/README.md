...
![Version: 0.17.0-rc.10](https://img.shields.io/badge/Version-0.17.0--rc.10-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.17.10rc1](https://img.shields.io/badge/AppVersion-0.17.10rc1-informational?style=flat-square)
...
| sandboxes.juicefsFormatJob.annotations | object | `{}` | Additional annotations applied to the JuiceFS formatter Job and pod. Changing this renames the Job, so the formatter runs again. |
| sandboxes.juicefsFormatJob.labels | object | `{}` | Additional labels applied to the JuiceFS formatter Job and pod. |
