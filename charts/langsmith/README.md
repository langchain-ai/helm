...
| config.sandboxes.juicefs.csi.configSecretNamespace | string | `""` | Namespace for the JuiceFS CSI config Secret. Empty uses `config.sandboxes.namespace`. |
