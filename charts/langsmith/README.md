...
| sandboxes.juicefs.csi.cacheLargeWrite | bool | `true` | Cache uploaded blocks for immediate same-node rereads on the SSD-selected JuiceFS mount pod patch. |
