...
| config.sandboxes.sandboxHost.allowPrivateIPCallbacks | bool | `true` | Whether sandbox callback validation should allow private IP and localhost targets. This renders SSRF_ALLOW_PRIVATE_IPS_CALLBACKS for sandbox-host. |
