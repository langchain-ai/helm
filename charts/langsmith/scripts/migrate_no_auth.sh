...
UPDATE public.tenants SET display_name = 'Default', config = config || '{"is_personal": false, "max_identities": 100, "max_workspaces": -1}' where id='00000000-0000-0000-0000-000000000000';
